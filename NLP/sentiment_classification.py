...
def classify_file(input_path, output_path, text_field="cleaned_text"):
    ...
    for entry in data:
        ...
        entry["vader_compound"] = vs["compound"]
        entry["vader_pos"] = vs["pos"]
        entry["vader_neu"] = vs["neu"]
        entry["vader_neg"] = vs["neg"]
        entry["vader_label"] = label_from_compound(vs["compound"])
        entry["textblob_polarity"] = tb
        entry["textblob_label"] = label_from_compound(tb)
